...
export class AssignmentsService {
  ...
  getAssignments(page: number, limit: number): Observable<any> {
    ...
    return this.http.get<Assignment[]>(
      this.uri_api + '?page=' + page + '&limit=' + limit
    );
  ...
  getAssignment(id: number): Observable<Assignment | undefined> {
    ...
    //   }),
    //   tap((a) => {
    //     if (a) console.log('ICI DANS LE TAP ' + a.nom);
    //   }),
    //   map((a) => {
    //     if (a) {
    //       a.nom += ' TOTOTOTO';
    ...
    //   }),
    //   catchError(
    //     this.handleError<Assignment>(
    //       'Erreur dans le traitement de assignment avec id = ' + id
    //     )
    //   )
    // );
